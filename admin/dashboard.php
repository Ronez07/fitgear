...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>Analytics</h3>
         <p>View sales,  top products</p>
         <a href="analytics.php" class="btn">see analytics</a>
      </div>
      <div class="box">
         <?php
         ...
         <p>product reviews</p>
         <a href="reviews.php" class="btn">see reviews</a>
      </div>
      <div class="box">
         <?php
         ...
         <p>active coupons</p>
         <a href="coupons.php" class="btn">see coupons</a>
      </div>
